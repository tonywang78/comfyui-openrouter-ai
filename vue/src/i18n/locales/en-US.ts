export default {
  ...
  auth: {
    ...
    imageCaptchaPlaceholder: 'Image captcha',
    pleaseEnterImageCaptcha: 'Please enter image captcha',
    clickToRefreshCaptcha: 'Click to refresh',
    getCode: 'Get Code',
    sendingCode: 'Sending...',
    resendCode: 'Resend',
  ...
  system: {
    ...
    workflow: {
      ...
      dialog: {
        ...
        cover: 'Cover Image',
        coverPlaceholder: 'Enter image/GIF/video URL or upload',
        coverUploading: 'Processing media…',
        upload: 'Upload',
        description: 'Description',
        ...
        inputConfigHint: 'Only parsed supported fields can be added or removed freely',
        addInput: 'Add Input Field',
        removeInput: 'Remove',
        selectInputField: 'Select input field',
        selectInputFieldToAdd: 'Select a field to add',
        noAvailableInputFields: 'No more input fields available',
        inputConfigEmpty: 'Select a field from the dropdown above, then click Add Input Field',
        configuredInputs: '{count} configured',
        availableInputs: '{count} available',
        outputConfig: 'Output Node Configuration',
        outputConfigHint: 'Select the workflow result node (e.g. SaveImage)',
        outputConfigEmpty: 'Please add at least one output node',
